...
export const REPEATED_CLICK_ADVANCE_DURATION = 400;
export const REPEATED_CLICK_THRESHOLD_POSITION = 0.4;
export const REPEATED_CLICK_BEFORE_THRESHOLD_DESTINATION_POSITION = 1;
export const REPEATED_CLICK_AFTER_THRESHOLD_DESTINATION_POSITION = 0.8;
