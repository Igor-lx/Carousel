...
export const REPEATED_CLICK_DESTINATION_POSITION = 0.7;
export const REPEATED_CLICK_SPEED_MULTIPLIER = 14;
export const REPEATED_CLICK_START_ACCELERATION = 0.2;
export const REPEATED_CLICK_END_DECELERATION = 0.5;
